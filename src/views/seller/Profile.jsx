...
import {profile_image_upload,messageClear,profile_info_add,change_password} from '../../store/Reducers/authReducerSlice'
import { useEffect, useState } from "react";
import toast from "react-hot-toast";
import { overrideStyle } from "../../utils/utils";
import { create_stripe_connect_account} from "../../store/Reducers/sellerReducerSlice";
          ...
          <div className="w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]">
            <div className="flex justify-center items-center py-3">
              {userInfo?.image ? (
                <label
                  htmlFor="img"
                  className="h-[200px] w-[200px] relative p-3 cursor-pointer overflow-hidden"
                >
                  <img
                  ...
                  <p>
                    {userInfo.payment === "active" ? (
                      ...
                      <button 
                        ...
                        className="bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded transition-colors"
                      >
                        {loader ? 'Connecting...' : 'Click Active'}
                      </button>
                    )}
                  </p>
                </div>
                ...
                <form onSubmit={add}>
                  <div className="flex flex-col w-full gap-1 mb-2">
                    ...
                    <input
                      ...
                      className="px-4 py-1 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                      type="text"
                      name="shopName"
                      id="Shop"
                  ...
                  <div className="flex flex-col w-full gap-1 mb-2">
                    <label htmlFor="subdistrict">Sub Distric Name</label>
                    <input
            ...
            <div className="bg-[#6a5fdf] rounded-md text-[#d0d2d6] p-4">
              ...
              <form onSubmit={handlePasswordChange}>
               ...
               <div className="flex flex-col w-full gap-1 mb-2">
                ...
                <button
                  className="bg-red-500 hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-5 py-1.5 my-2
                        "
                >
                  {
