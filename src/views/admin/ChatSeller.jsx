...
export default function ChatSeller() {
  const { sellers, activeSeller, currentSeller, seller_admin_message,successMessage } =
  ...
  return (
    <div className="px-2 lg:px-7 py-5">
      <h1 className="text-[18px] font-semibold mb-3">Chat Seller </h1>
      <div className="w-full px-4 py-4 bg-[#6a5fdf] rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto rounded-r-md">
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            <div className="flex justify-between items-center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  ...
                  <span className="text-white font-semibold">{currentSeller?.shopInfo?.shopName}</span>
                </div>
              )}

              <div
                onClick={() => setShow(!show)}
                className="w-[35px] flex md:hidden h-[35px] rounded-sm bg-blue-500 hover:shadow-blue-500/50 justify-center cursor-pointer items-center text-white"
              >
                <span>
                  <FaList />
                </span>
                  ...
                  seller_admin_message.map((m, i) => {
                    if (m.senderId === sellerId) {
                      return (
                        ...
                        >
                          <div className="flex justify-start items-start gap-2 mg-:px-3 py-2 max-w-full lg:max-w-[85%]">
                            <div>
                              {currentSeller &&
                                <img
            ...
            <form onSubmit={send} className="flex gap-3">
              <input
                ...
                className="w-full flex justify-between items-center px-2 border border-slate-700 py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]"
