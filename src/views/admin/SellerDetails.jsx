...
import { get_seller,seller_status_update,messageClear } from '../../store/Reducers/sellerReducerSlice';
...
export default function SellerDetails() {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <h1 className="text-[18px] font-semibold mb-3">Seller Details</h1>
            ...
            <div className="w-full flex flex-wrap text-[#d0d2d6]">
                <div className="w-3/12 flex justify-center items-center py-3">
                    <div>
                        {
                            seller?.image ? 
                            <img className="w-full h-[230px] rounded-md" src={seller?.image} alt="demo" />
                            :
                ...
                <form onSubmit={submit}>
                    <div className="flex gap-4 py-3">
                        <select 
                            ...
                            className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]" name="" id="">
